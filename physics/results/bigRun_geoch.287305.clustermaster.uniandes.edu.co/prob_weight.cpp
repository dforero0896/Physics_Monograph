...
*/
/*Writes in file prob_wight.dat the relative importances of the "Steps_in_energy" energies in the [emin,Emax] interval.*/
...
int main(int argc, char const *argv[]) {
  ...
  float E_min, E_max;
  int Steps;
  /*Limits in energy and number of these to consider for each spectrum*/
  E_min = atof(argv[1]);
  E_max = atof(argv[2]);
  Steps = atoi(argv[3]);
  ...
  /*Figure out how much does each spectrum contribute to total flux.*/
  ...
  /*Build a single spectrum that takes into account the relative importance of each of them.*/
