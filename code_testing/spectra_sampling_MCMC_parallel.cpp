/*
g++ -fopenmp -o spectra_sampling_MCMC_parallel.o spectra_sampling_MCMC_parallel.cpp `gsl-config --cflags --libs`
*/
#include <iostream>
using namespace std;
#include <sstream>
...
double mh_sampling(double spectrum_array[4500][2], int samples){
  ...
  markov_chain.reserve(N);
  #pragma parallel num_threads(threads)
  {
